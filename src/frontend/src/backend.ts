...
export class Backend implements backendInterface {
    ...
    async addDua(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addDua(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteDua(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteDua(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentUser(arg0: string): Promise<User> {
        if (this.processError) {
            try {
    ...
    async getDuaById(arg0: bigint): Promise<Dua> {
        if (this.processError) {
            try {
    ...
    async getQuranSettings(): Promise<[string, Array<[bigint, boolean]>]> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuranSettings();
                return [
                    result[0],
                    result[1]
                ];
    ...
    async setReciterUrl(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setReciterUrl(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSurahEnabled(arg0: string, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSurahEnabled(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
